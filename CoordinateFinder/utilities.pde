...
PImage mapImage; // picture of author's face, should be: data/pic.jpg in sketch folder
...
void displayHeader()  // Displays title and authors face on screen
    ...
    //image(mapImage, width-mapImage.width/2,25,mapImage.width/2,mapImage.height/2); 
